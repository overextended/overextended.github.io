...
<Callout type="info">These events **are safe** to trigger and handle in other scripts.</Callout>
...
<Callout type="warning">These events **should not** be triggered by any other scripts.</Callout>
