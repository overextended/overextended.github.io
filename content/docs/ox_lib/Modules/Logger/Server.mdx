...
### Create your [Datadog](https://www.datadoghq.com/) account [step]
...
### Create an [API key](https://app.datadoghq.com/organization-settings/api-keys) [step]
...
<Tabs items={["Cloud", "Self-hosted"]}>
  <Tab>
    ...
    ### Create your [Grafana](https://grafana.com/) account [step]
    ### Head to [My Account](https://grafana.com/auth/sign-in/?plcmt=top-nav&cta=myaccount) [step]
    ### Setup Loki [step]
...
#### Upgrading to `Hobby` or `Pro` tier (optional) [step]
