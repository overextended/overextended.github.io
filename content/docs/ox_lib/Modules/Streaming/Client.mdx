...
<Callout>Remember to call `RemoveAnimDict(dict)` at the end of your code!</Callout>
...
<Callout>Remember to call `RemoveAnimSet(set)` at the end of you code!</Callout>
...
<Callout>Remember to call `ReleaseScriptAudioBank(set)` at the end of you code!</Callout>
...
<Callout>Remember to call `SetModelAsNoLongerNeeded(model)` at the end of you code!</Callout>
...
<Callout>Remember to call `RemoveNamedPtfxAsset(dict)` at the end of you code!</Callout>
...
<Callout>Remember to call `RemoveWeaponAsset(weaponType)` at the end of you code!</Callout>
