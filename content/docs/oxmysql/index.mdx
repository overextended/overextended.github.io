...
<ResourceLinks repo="oxmysql" npm />
...
### Download and install [MariaDB](https://mariadb.com/downloads/community/) [step]

### Download the [latest release](https://github.com/overextended/oxmysql/releases/latest) of oxmysql [step]
