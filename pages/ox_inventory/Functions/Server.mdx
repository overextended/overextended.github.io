...
Use [ReturnInventory](./Server/#returninventory) to return the confiscated inventory back to
the player.
...
Use it alongside [ConfiscateInventory](./Server/#confiscateinventory.md).
