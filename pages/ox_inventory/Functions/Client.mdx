...
<Tabs items={['Player', 'Shop', 'Stash', 'Crafting', 'Police Evidence', 'Glovebox / Trunk']}>
  ...
  <Tab>
    Open the fourth "General Store" [location](https://github.com/communityox/ox_inventory/blob/main/data/shops.lua#L14).
  ...
  <Tab>
    Open the first stash in [data/stashes](https://github.com/communityox/ox_inventory/blob/main/data/stashes.lua#L2-L19).
  ...
  <Tab>
    Opens the [second location](https://github.com/CommunityOx/ox_inventory/blob/main/data/crafting.lua#L17) of the debug_crafting recipe.
