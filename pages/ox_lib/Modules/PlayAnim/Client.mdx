...
- animFlags?: `AnimationFlags`
  - The animation flags. You can find these in the code.
  - Default: `0`
- startPhase?: `number`
...
- controlFlags?: `ControlFlags`
  - Flags to manipulate how the character is controlled by the animation. You can find these in the code.
  - Default: `0`
- overrideCloneUpdate?: `boolean`
  - Whether any clone updates should override.
  - Default: `false`
