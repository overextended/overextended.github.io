...
<CreatorCodes>
  ...
  <CreatorCode storeName="Dolu Mods" storeLink="https://dolu.tebex.io/" code="overextended" percentOff={15} storeImage="/static/creators/dolu.png"/>
  ...
  <CreatorCode storeName="Roleplay inventory icons" storeLink="https://pixel-art-roleplay-inventory-i.tebex.io/" code="ox10" percentOff={10} storeImage="/static/creators/artworkInventory.gif"/>
  <CreatorCode storeName="Renewed Scripts" storeLink="https://renewed.tebex.io/" code="ox15" percentOff={15} storeImage="/static/creators/renewed.png"/>
  <CreatorCode storeName="Wasabi Scripts" storeLink="https://store.wasabiscripts.com/" code="OX20" percentOff={20} storeImage="/static/creators/wasabi.png"/>
</CreatorCodes>
