...
For some examples you can refer to [defaults.lua](https://github.com/communityox/ox_target/blob/main/client/defaults.lua) or [debug.lua](https://github.com/communityox/ox_target/blob/main/client/debug.lua).
