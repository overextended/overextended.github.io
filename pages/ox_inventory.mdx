...
### Download a [release](https://github.com/communityox/ox_inventory/releases) or build the source code.
...
- Money as an item may conflict with banking/account systems.
  - You can sync these values with [server.syncInventory](https://github.com/communityox/ox_inventory/blob/aff8ef9e9ee3f93f177ce03b3f37895ff5781800/modules/bridge/nd/server.lua#L64-L77).

Refer to issue [#1297](https://github.com/communityox/ox_inventory/issues/1297) for known compatibility issues.
...
Copy the `ox` directory from the [bridge](https://github.com/communityox/ox_inventory/tree/main/modules/bridge) directory and give it the name you used above.
...
Take a look at the [mysql](https://github.com/communityox/ox_inventory/blob/main/modules/mysql/server.lua) module. You'll need to reference your player/vehicle tables and id columns.
