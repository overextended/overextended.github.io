The input for zones differs slightly from all other options, instead taking the [zone](../../ox_lib/Modules/Zones/Shared.md) properties and two additional properties (drawSprite, and options).
