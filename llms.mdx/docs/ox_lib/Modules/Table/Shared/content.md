# Shared (/docs/ox_lib/Modules/Table/Shared)



Adds additional functions alongside the standard table library.

## lib.table.contains [#libtablecontains]
...
## lib.table.matches [#libtablematches]
...
## lib.table.deepclone [#libtabledeepclone]
...
## lib.table.freeze [#libtablefreeze]
...
## lib.table.isFrozen [#libtableisfrozen]
