# Shared (/docs/ox_lib/Modules/Zones/Shared)
...
<Callout>
  Currently zones only have basic support on the server side. Some features will not work such as
  `onEnter`, `onExit`, and `inside`.
</Callout>

## lib.zones.poly [#libzonespoly]
...
## lib.zones.sphere [#libzonessphere]
