# Context Menu (/docs/ox_lib/Modules/Interface/Client/context)
...
## lib.showContext [#libshowcontext]
...
## lib.hideContext [#libhidecontext]
...
## lib.getOpenContextMenu [#libgetopencontextmenu]
...
<Callout>
  Avoid constantly re-registering a menu that does not depend on any outside values (A.K.A a static
  menu).
</Callout>
...
![menu\_example](https://i.imgur.com/TkaH2P9.png)
![metadata](https://i.imgur.com/0mMmwgi.png)
![sub\_menu](https://i.imgur.com/RbT1tKX.png)
![event\_menu](https://i.imgur.com/zjIiROj.png)
