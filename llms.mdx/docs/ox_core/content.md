...
## txAdmin recipe [#txadmin-recipe]

If you're looking to quickly install and setup ox\_core, try using [our recipe](https://github.com/overextended/txAdminRecipe).
...
## Using ox\_core in your resources [#using-ox_core-in-your-resources]
...
<Tabs items="['fxmanifest.lua', 'require']">
  ...
  <Tab>
    If you prefer, you can use our [require](../ox_lib/Modules/Require/Shared) function from [ox\_lib](../ox_lib).
...
To get started, try our [fivem-typescript-boilerplate](https://github.com/overextended/fivem-typescript-boilerplate) and install the ox\_core package.
...
* `ox:plateFormat`
  * Default: `"........"`
  * See [SET\_DEFAULT\_VEHICLE\_NUMBER\_PLATE\_TEXT\_PATTERN](https://docs.fivem.net/natives/?_0x79780FD2).
* `ox:deathSystem`
  * Default: `true`
