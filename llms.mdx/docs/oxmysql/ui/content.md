# Using the Debug UI (/docs/oxmysql/ui)
...
<Callout type="info">
  You *do not* need to have the `mysql_debug` enabled to use the debug ui.
</Callout>
...
![oxmysql\_ui\_main](https://i.imgur.com/iQqWELJ.png)
...
![oxmysql\_ui\_queries](https://i.imgur.com/gZpJoIg.png)
