# Server (/docs/ox_inventory/Functions/Server)
...
## forceOpenInventory [#forceopeninventory]
...
## GetSlotIdsWithItem [#getslotidswithitem]
...
## GetContainerFromSlot [#getcontainerfromslot]
...
<Callout type="error">
  The owner parameter is not for access control of the stash, use the
  [`openInventory`](./Server/Hooks.mdx#openinventory) hook for access control.
</Callout>
...
## CreateTemporaryStash [#createtemporarystash]
...
## CreateDropFromPlayer [#createdropfromplayer]
