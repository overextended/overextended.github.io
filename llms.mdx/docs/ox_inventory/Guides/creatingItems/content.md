# Creating Items (/docs/ox_inventory/Guides/creatingItems)
...
All of the items are defined in the [/data/items.lua](https://github.com/overextended/ox_inventory/blob/main/data/items.lua) file with key, value pairs.
...
## Making the item usable [#making-the-item-usable]
...
## Creating container items [#creating-container-items]
