# Ox Inventory (/docs/ox_inventory)
...
<div className="fd-steps">
  ...
  <div className="fd-step">
    ...
    * Download the [latest release](https://github.com/overextended/ox_inventory/releases/latest).
  ...
  <div className="fd-step">
    ### Resource start order [#resource-start-order-step]
...
## Using an unsupported framework [#using-an-unsupported-framework]
...
<div className="fd-steps">
  <div className="fd-step">
    ### Setup a bridge submodule [#setup-a-bridge-submodule-step]
  ...
  <div className="fd-step">
    ### Setup database references [#setup-database-references-step]
